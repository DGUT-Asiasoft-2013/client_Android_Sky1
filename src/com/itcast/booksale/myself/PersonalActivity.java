...
AvatarView avatar;//头像
TextView p_account,p_email,p_name,p_phone,p_qq;//账号，邮箱，昵称，电话，QQ
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		avatar=(AvatarView) findViewById(R.id.avatar);//头像
		
		p_account=(TextView) findViewById(R.id.personal_account);//账户
		p_email=(TextView) findViewById(R.id.personal_email);//邮箱
		p_name=(TextView) findViewById(R.id.personal_name);//昵称
		p_phone=(TextView) findViewById(R.id.personal_phone);//电话号码
