...
public class SpendingBillsActivity extends Activity {
	...
	BaseAdapter adapter = new BaseAdapter() {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			// TextView textState = (TextView)
			// convertView.findViewById(R.id.text_bills_date);// 订单的状态
			...
			/*
			 * // 判断不同的订单状态 switch (listData.getFinish()) { case state[0]:
			 * textState.setText("待付款"); textState.setTextColor(0xD2691E);
			 * break; case state[1]: textState.setText("交易关闭");
			 * textState.setTextColor(0xD9D9D9); break; default:
			 * textState.setText(""); break;
			 * 
			 * }
			 */
