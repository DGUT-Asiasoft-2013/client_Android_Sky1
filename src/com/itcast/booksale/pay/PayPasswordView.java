...
public class PayPasswordView{
	...
	private TextView sure;//ȷ��֧��
	@ViewInject(R.id.pay_box1)
	private TextView box1;//�����ĵ�1������
	@ViewInject(R.id.pay_box2)
	private TextView box2;//�����ĵ�2������
	@ViewInject(R.id.pay_box3)
	private TextView box3;//�����ĵ�3������
	@ViewInject(R.id.pay_box4)
	private TextView box4;//�����ĵ�4������
	@ViewInject(R.id.pay_box5)
	private TextView box5;//�����ĵ�5������
	@ViewInject(R.id.pay_box6)
	private TextView box6;//�����ĵ�6������
	@ViewInject(R.id.pay_title)
	private TextView title;//������֧������
	//@ViewInject(R.id.pay_content)
	//private TextView content;//���ѽ��
